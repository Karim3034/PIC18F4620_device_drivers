# 1 "MCAL_Layer/I2C/hal_MSSP_I2C.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/I2C/hal_MSSP_I2C.c" 2
...
# 10 "MCAL_Layer/I2C/../std_libraries.h" 2
...
# 11 "MCAL_Layer/I2C/../std_libraries.h" 2
...
# 31 "MCAL_Layer/I2C/../MCAL_std_types.h"
...
# 12 "MCAL_Layer/I2C/hal_MSSP_I2C.h" 2

# 1 "MCAL_Layer/I2C/../hal_gpio.h" 1
# 14 "MCAL_Layer/I2C/../hal_gpio.h"
# 1 "MCAL_Layer/I2C/../device_config.h" 1
# 10 "MCAL_Layer/I2C/../device_config.h"
# 1 "MCAL_Layer/I2C/../device_config.h" 1
# 10 "MCAL_Layer/I2C/../device_config.h" 2
...
# 14 "MCAL_Layer/I2C/../hal_gpio.h" 2

# 1 "MCAL_Layer/I2C/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/I2C/../hal_gpio.h" 2
# 33 "MCAL_Layer/I2C/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 13 "MCAL_Layer/I2C/hal_MSSP_I2C.h" 2
...
# 1 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_gen_config.h" 1
# 14 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_config.h" 2
# 42 "MCAL_Layer/I2C/../Interrupt/mcal_interrupt_config.h"
typedef enum{
    INTERRUPT_LOW_PRIORITY = 0,
    INTERRUPT_HIGH_PRIORITY
}interrupt_priority;
# 12 "MCAL_Layer/I2C/../Interrupt/mcal_internal_interrupt.h" 2
# 14 "MCAL_Layer/I2C/hal_MSSP_I2C.h" 2
...
# 7 "MCAL_Layer/I2C/hal_MSSP_I2C.c" 2
...
Std_ReturnType MSSP_I2C_Init(const mssp_i2c_t *i2c_obj) {
    ...
    if (((void*)0) == i2c_obj) {
        ...
        if (i2c_obj->i2c_cfg.i2c_mode == 1) {
            ...
            (SSPCON1bits.SSPM = i2c_obj->i2c_cfg.mssp_i2c_mode_cfg);
            SSPCON1bits.WCOL = 0;
            SSPCON1bits.SSPOV = 0;
            SSPCON1bits.CKP = 1;
...
static void master_clock_cfg(const mssp_i2c_t *i2c_obj) {
    (SSPCON1bits.SSPM = i2c_obj->i2c_cfg.mssp_i2c_mode_cfg);
    SSPADD = (uint8) ((8000000UL / (4 * i2c_obj->i2c_clock)) - 1);
}
...
static void SMBus_cfg(const mssp_i2c_t *i2c_obj) {
    if (i2c_obj->i2c_cfg.i2c_SMBus == 1) {
        (SSPSTATbits.SMP=0);
    } else if (i2c_obj->i2c_cfg.i2c_slew_rate == 1) {
        (SSPSTATbits.SMP=1);
    } else {
...
# 214 "MCAL_Layer/I2C/hal_MSSP_I2C.c"
static void I2C_Interrupt_cfg(const mssp_i2c_t *i2c_obj) {
# 244 "MCAL_Layer/I2C/hal_MSSP_I2C.c"
}

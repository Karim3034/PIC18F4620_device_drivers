...
# 11 "MCAL_Layer/Timer/hal_timer0.h"
...
# 11 "MCAL_Layer/Timer/hal_timer0.h" 2

# 1 "MCAL_Layer/Timer/../MCAL_std_types.h" 1
# 12 "MCAL_Layer/Timer/../MCAL_std_types.h"
...
# 12 "MCAL_Layer/Timer/../MCAL_std_types.h" 2

# 1 "MCAL_Layer/Timer/../compiler.h" 1
# 11 "MCAL_Layer/Timer/../compiler.h"
...
# 11 "MCAL_Layer/Timer/../compiler.h" 2
# 13 "MCAL_Layer/Timer/../MCAL_std_types.h" 2
# 31 "MCAL_Layer/Timer/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/Timer/hal_timer0_cfg.h" 1
...
# 1 "MCAL_Layer/Timer/../Interrupt/../hal_gpio.h" 1
# 14 "MCAL_Layer/Timer/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/Timer/../device_config.h" 1
# 10 "MCAL_Layer/Timer/../device_config.h"
# 1 "MCAL_Layer/Timer/../device_config.h" 1
# 10 "MCAL_Layer/Timer/../device_config.h" 2
...
# 14 "MCAL_Layer/Timer/../Interrupt/../hal_gpio.h" 2

# 1 "MCAL_Layer/Timer/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/Timer/../Interrupt/../hal_gpio.h" 2
# 33 "MCAL_Layer/Timer/../Interrupt/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_gen_config.h" 1
# 14 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h" 2
# 42 "MCAL_Layer/Timer/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
# 40 "MCAL_Layer/Timer/hal_timer0.h"
typedef enum {
    PRESCALER_DIV_2,
    PRESCALER_DIV_4,
    PRESCALER_DIV_8,
...
static void __attribute__((inline)) Timer0_timer_mode_config(timer0_t* timer_obj);
static void __attribute__((inline)) Timer0_register_size_config(timer0_t* timer_obj);
static void __attribute__((inline)) Timer0_increment_type_config(timer0_t* timer_obj);
static void __attribute__((inline)) Timer0_prescaler_config(timer0_t* timer_obj);
...
# 44 "MCAL_Layer/Timer/hal_timer0.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
...
static void __attribute__((inline)) Timer0_timer_mode_config(timer0_t* timer_obj) {
    if (timer_obj->timer0_Mode == 0) {
        (T0CONbits.T0CS=0);
    } else if (timer_obj->timer0_Mode == 1) {
        (T0CONbits.T0CS=1);
...
static void __attribute__((inline)) Timer0_register_size_config(timer0_t* timer_obj) {
    if (timer_obj->timer0_register_size == 1) {
        (T0CONbits.T08BIT = 1);
    } else if (timer_obj->timer0_register_size == 0) {
        (T0CONbits.T08BIT = 0);
    } else {
...
static void __attribute__((inline)) Timer0_increment_type_config(timer0_t* timer_obj) {
    if (timer_obj->timer0_increment_type == 0) {
        (T0CONbits.T0SE = 0);
    } else if (timer_obj->timer0_register_size == 1) {
        (T0CONbits.T0SE = 1);
    } else {
...
static void __attribute__((inline)) Timer0_prescaler_config(timer0_t* timer_obj) {
    if (timer_obj->timer0_prescaler_status == 0) {
        (T0CONbits.PSA = 0);
        (T0CONbits.T0PS = timer_obj->prescaler_value);
    } else if (timer_obj->timer0_prescaler_status == 1) {
        (T0CONbits.PSA = 1);
    } else {

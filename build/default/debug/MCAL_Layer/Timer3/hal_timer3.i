...
# 31 "MCAL_Layer/Timer3/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/Timer3/../Interrupt/../hal_gpio.h" 1
# 14 "MCAL_Layer/Timer3/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/Timer3/../device_config.h" 1
# 10 "MCAL_Layer/Timer3/../device_config.h"
# 1 "MCAL_Layer/Timer3/../device_config.h" 1
# 10 "MCAL_Layer/Timer3/../device_config.h" 2
...
# 14 "MCAL_Layer/Timer3/../Interrupt/../hal_gpio.h" 2

# 1 "MCAL_Layer/Timer3/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/Timer3/../Interrupt/../hal_gpio.h" 2
# 33 "MCAL_Layer/Timer3/../Interrupt/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_gen_config.h" 1
# 14 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_config.h" 2
# 42 "MCAL_Layer/Timer3/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void __attribute__((inline)) Timer3_timer_mode_config(timer3_t* timer_obj);
...
Std_ReturnType TIMER3_Init(timer3_t* timer_obj) {
    ...
    if (((void*)0) == timer_obj) {
        ...
        (T3CONbits.TMR3ON = 0);
        (T3CONbits.T3CKPS = timer_obj->prescaler_value);
...
# 39 "MCAL_Layer/Timer3/hal_timer3.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
...
static void __attribute__((inline)) Timer3_timer_mode_config(timer3_t* timer_obj) {
    if (timer_obj->timer3_Mode == 0) {
        (T3CONbits.TMR3CS=0);
    } else if (timer_obj->timer3_Mode == 1) {
        (T3CONbits.TMR3CS=1);
        if (timer_obj->timer3_counter_mode == 0) {
            (T3CONbits.T3SYNC=0);
        } else if (timer_obj->timer3_counter_mode == 1) {
            (T3CONbits.T3SYNC=1);
        } else {

...
# 10 "MCAL_Layer/ADC/../std_libraries.h"
...
# 31 "MCAL_Layer/ADC/../MCAL_std_types.h"
...
# 14 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/ADC/../device_config.h" 1
# 10 "MCAL_Layer/ADC/../device_config.h"
# 1 "MCAL_Layer/ADC/../device_config.h" 1
# 10 "MCAL_Layer/ADC/../device_config.h" 2
...
# 14 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h" 2

# 1 "MCAL_Layer/ADC/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h" 2
# 33 "MCAL_Layer/ADC/../Interrupt/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 8 "MCAL_Layer/ADC/haLadc.c" 2

static void __attribute__((inline)) adc_input_channel_port_configure(adc_channel_select_t channel);
static void __attribute__((inline)) adc_set_result_format(adc_conf_t *adc);
static void __attribute__((inline)) adc_set_voltage_ref(adc_conf_t *adc);
...
Std_ReturnType ADC_Get_Conversion_Result(adc_conf_t *adc, adc_result* result) {
    ...
    if (((void*)0) == adc) {
        ...
        if (adc->result_format == 1) {
            *result = (adc_result) ((ADRESH << 8) + ADRESL);
        } else if (adc->result_format == 0) {
...
static void __attribute__((inline)) adc_set_result_format(adc_conf_t *adc) {
    if (1 == adc->result_format) {
        (ADCON2bits.ADFM=1);
    } else if (0 == adc->result_format) {
        (ADCON2bits.ADFM=0);
    } else {
        (ADCON2bits.ADFM=1);
    }
...
static void __attribute__((inline)) adc_set_voltage_ref(adc_conf_t *adc) {
    if (0 == adc->voltage_reference) {
        do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1 = 0; }while(0);;
    } else if (1 == adc->voltage_reference) {

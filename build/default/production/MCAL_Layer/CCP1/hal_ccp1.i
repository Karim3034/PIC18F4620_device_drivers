...
# 31 "MCAL_Layer/CCP1/../MCAL_std_types.h"
...
# 13 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/CCP1/../Interrupt/../hal_gpio.h" 1
# 14 "MCAL_Layer/CCP1/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/CCP1/../device_config.h" 1
# 10 "MCAL_Layer/CCP1/../device_config.h"
# 1 "MCAL_Layer/CCP1/../device_config.h" 1
# 10 "MCAL_Layer/CCP1/../device_config.h" 2
...
# 14 "MCAL_Layer/CCP1/../Interrupt/../hal_gpio.h" 2

# 1 "MCAL_Layer/CCP1/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/CCP1/../Interrupt/../hal_gpio.h" 2
# 33 "MCAL_Layer/CCP1/../Interrupt/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 1 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_gen_config.h" 1
# 14 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h" 2
# 42 "MCAL_Layer/CCP1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
Std_ReturnType CCP_Init(const ccp_t* ccp_obj) {
    ...
    if (((void*)0) == ccp_obj) {
        ...
        if (CCP_CAPTURE_MODE_SELECTED == ccp_obj->ccp_mode) {
            ...
            if (((uint8)0x0C) == ccp_obj->ccp_mode_variant) {
                if (ccp1 == ccp_obj->ccp_num)
            ...
            PR2 = (uint8) (((float) 8000000UL / (float) (ccp_obj->pwm_frequency * 4.0 * ccp_obj->timer2_prescaler_value * ccp_obj->timer2_postscaler_value)) - 1);
...
# 244 "MCAL_Layer/CCP1/hal_ccp1.c"
    (INTCONbits.GIE=1);
    (INTCONbits.PEIE=1);
# 266 "MCAL_Layer/CCP1/hal_ccp1.c"
}

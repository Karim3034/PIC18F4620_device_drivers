...
# 31 "MCAL_Layer/Interrupt/../MCAL_std_types.h"
...
# 14 "MCAL_Layer/Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/Interrupt/../device_config.h" 1
# 10 "MCAL_Layer/Interrupt/../device_config.h"
# 1 "MCAL_Layer/Interrupt/../device_config.h" 1
# 10 "MCAL_Layer/Interrupt/../device_config.h" 2
...
static InterruptHandler RB4_InterruptHandler_RISING = ((void*)0);
static InterruptHandler RB4_InterruptHandler_FALLING = ((void*)0);
static InterruptHandler RB5_InterruptHandler_RISING = ((void*)0);
static InterruptHandler RB5_InterruptHandler_FALLING = ((void*)0);
static InterruptHandler RB6_InterruptHandler_RISING = ((void*)0);
static InterruptHandler RB6_InterruptHandler_FALLING = ((void*)0);
static InterruptHandler RB7_InterruptHandler_RISING = ((void*)0);
static InterruptHandler RB7_InterruptHandler_FALLING = ((void*)0);
...
# 166 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
        (INTCONbits.GIE=1);
        (INTCONbits.PEIE=1);
...
# 213 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
                (INTCONbits.GIE=1);
                (INTCONbits.PEIE=1);
...
# 350 "MCAL_Layer/Interrupt/mcal_external_interrupt.c"
static Std_ReturnType Interrupt_INTx_Clear_Flag(const interrupt_INTx_t * interrupt_obj) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if (((void*)0) == interrupt_obj) {
        ret = (Std_ReturnType)0x00;

...
# 31 "MCAL_Layer/Timer1/../MCAL_std_types.h"
...
# 1 "MCAL_Layer/Timer1/../Interrupt/../hal_gpio.h" 1
# 14 "MCAL_Layer/Timer1/../Interrupt/../hal_gpio.h"
# 1 "MCAL_Layer/Timer1/../device_config.h" 1
# 10 "MCAL_Layer/Timer1/../device_config.h"
# 1 "MCAL_Layer/Timer1/../device_config.h" 1
# 10 "MCAL_Layer/Timer1/../device_config.h" 2
...
# 14 "MCAL_Layer/Timer1/../Interrupt/../hal_gpio.h" 2

# 1 "MCAL_Layer/Timer1/../GPIO/hal_gpio_cfg.h" 1
# 15 "MCAL_Layer/Timer1/../Interrupt/../hal_gpio.h" 2
# 33 "MCAL_Layer/Timer1/../Interrupt/../hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 42 "MCAL_Layer/Timer1/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void __attribute__((inline)) Timer1_timer_mode_config(timer1_t* timer_obj);
static void __attribute__((inline)) Timer1_osc_config(timer1_t* timer_obj);
...
Std_ReturnType TIMER1_Init(timer1_t* timer_obj) {
    ...
    if (((void*)0) == timer_obj) {
        ...
        (T1CONbits.TMR1ON = 0);
        (T1CONbits.T1CKPS = timer_obj->prescaler_value);
...
static void __attribute__((inline)) Timer1_timer_mode_config(timer1_t* timer_obj) {
    if (timer_obj->timer1_Mode == 0) {
        (T1CONbits.TMR1CS=0);
    } else if (timer_obj->timer1_Mode == 1) {
        (T1CONbits.TMR1CS=1);
        if (timer_obj->timer1_counter_mode == 0) {
            (T1CONbits.T1SYNC=0);
        } else if (timer_obj->timer1_counter_mode == 1) {
            (T1CONbits.T1SYNC=1);
        } else {
...
static void __attribute__((inline)) Timer1_osc_config(timer1_t* timer_obj) {
    if (timer_obj->timer1_osc_cfg == 1) {
        (T1CONbits.T1OSCEN=1);
    } else if (timer_obj->timer1_register_size == 0) {
        (T1CONbits.T1OSCEN=0);
    } else {

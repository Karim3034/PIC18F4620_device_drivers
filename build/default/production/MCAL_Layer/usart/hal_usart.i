...
# 10 "MCAL_Layer/usart/../std_libraries.h"
...
# 11 "MCAL_Layer/usart/../std_libraries.h" 2
...
# 31 "MCAL_Layer/usart/../MCAL_std_types.h"
...
# 14 "MCAL_Layer/usart/../hal_gpio.h"
# 1 "MCAL_Layer/usart/../device_config.h" 1
# 10 "MCAL_Layer/usart/../device_config.h"
# 1 "MCAL_Layer/usart/../device_config.h" 1
# 10 "MCAL_Layer/usart/../device_config.h" 2
...
# 1 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_gen_config.h" 1
# 14 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_config.h" 2
# 42 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
void static eusart_baudrate_config(const usart_t *usart_obj) {
    ...
    switch (usart_obj->baud_rate_cfg) {
        case BAUDRATE_ASYN_8BIT_LOW_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 0;
            baudrate_temp = ((8000000UL / (float) usart_obj->baudrate) / 64.0) - 1;
            break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((8000000UL / (float) usart_obj->baudrate) / 16.0) - 1;
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            BAUDCONbits.BRG16 = 1;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((8000000UL / (float) usart_obj->baudrate) / 4.0) - 1;
            break;
...
void static eusart_async_tx_config(const usart_t *usart_obj) {
    if (usart_obj->usart_tx_cfg.usart_tx_enable == 1 ||
            usart_obj->usart_tx_cfg.usart_tx_enable == 0) {
        ...
        if (usart_obj->usart_tx_cfg.usart_tx_interrupt_enable == 1) {
            PIE1bits.TXIE = 1;

            (PIE1bits.TXIE = 1);
# 158 "MCAL_Layer/usart/hal_usart.c"
            (INTCONbits.GIE=1);
            (INTCONbits.PEIE=1);
        ...
        if (usart_obj->usart_tx_cfg.usart_tx_9bit_enable == 1 ||
...
void static eusart_async_rx_config(const usart_t *usart_obj) {
    if (usart_obj->usart_rx_cfg.usart_rx_enable == 1 ||
            usart_obj->usart_rx_cfg.usart_rx_enable == 0) {
        ...
        if (usart_obj->usart_rx_cfg.usart_rx_interrupt_enable == 1) {
            PIE1bits.RCIE = 1;

            (PIE1bits.RCIE = 1);
# 198 "MCAL_Layer/usart/hal_usart.c"
            (INTCONbits.GIE=1);
            (INTCONbits.PEIE=1);
        ...
        if (usart_obj->usart_rx_cfg.usart_rx_9bit_enable == 1 ||

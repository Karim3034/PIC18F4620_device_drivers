...
# 13 "./ECU_Layer/LED/../../MCAL_Layer/hal_gpio.h"
...
# 10 "./ECU_Layer/LED/../../MCAL_Layer/std_libraries.h"
...
# 10 "./ECU_Layer/LED/../../MCAL_Layer/std_libraries.h" 2
...
# 31 "./ECU_Layer/LED/../../MCAL_Layer/MCAL_std_types.h"
...
# 10 "./ECU_Layer/LED/../../MCAL_Layer/device_config.h"
# 1 "./ECU_Layer/LED/../../MCAL_Layer/device_config.h" 1
# 10 "./ECU_Layer/LED/../../MCAL_Layer/device_config.h" 2
...
# 33 "./ECU_Layer/LED/../../MCAL_Layer/hal_gpio.h"
typedef enum {
   GPIO_LOW,
   GPIO_HIGH
}logic_t;
...
# 20 "./ECU_Layer/DC_Motor/ecu_dc_motor.h"
typedef struct{
...
# 58 "./MCAL_Layer/Interrupt/mcal_external_interrupt.h"
...
# 32 "./MCAL_Layer/EEPROM/hal_eeprom.h"
...
# 39 "./MCAL_Layer/Timer1/hal_timer1.h"
typedef enum {
    PRESCALER_DIV_BY_1,
    PRESCALER_DIV_BY_2,
    PRESCALER_DIV_BY_4,
...
# 24 "./MCAL_Layer/Timer2/hal_timer2.h"
typedef enum {
...
# 34 "./MCAL_Layer/Timer3/hal_timer3.h"
typedef enum {
...
# 1 "./MCAL_Layer/I2C/hal_MSSP_I2C.h" 1
# 10 "./MCAL_Layer/I2C/hal_MSSP_I2C.h"
# 1 "./MCAL_Layer/I2C/hal_MSSP_I2C_cfg.h" 1
# 10 "./MCAL_Layer/I2C/hal_MSSP_I2C.h" 2
# 85 "./MCAL_Layer/I2C/hal_MSSP_I2C.h"
typedef struct{
...
int main() {
    ...
    obj.i2c_cfg.i2c_slew_rate = 1;
    obj.i2c_cfg.i2c_SMBus = 0;
    obj.i2c_cfg.i2c_slave_address = 0x62;
    obj.i2c_cfg.i2c_general_call = 0;
    obj.i2c_cfg.i2c_mode = 0;
    obj.i2c_cfg.mssp_i2c_mode_cfg = 0x06;
    obj.i2c_cfg.i2c_SMBus = 0;
    obj.I2C_Default_Interrupt_Handler = APP_receive_ISR;
    obj.I2C_RECEIVE_OVERFLOW_Interrupt_Handler = ((void*)0);
    obj.I2C_Write_Collision_Interrupt_Handler = ((void*)0);
    MSSP_I2C_Init(&obj);
    led_init(&led2);
    while (1) {
        if('b' == slave2_data){
